...
import Pic from '../../Assets/Our story/Nada-removebg.png'
import Image1 from '../../Assets/New folder/Logo N.png'
import our from '../Our story/our.module.css'
...
<div className=' w-100 mb-5  '>
    ...
    <div className="container  mb-5 mt-5 pt-4">
      <h1 className='d-flex justify-content-center pb-5 text-decoration-underline '>Our Story </h1>
      <div className="row">
        <div className="col-md-6">
          <img src={Pic}  width={500} alt="" />
        </div>
        <div className="col-md-6 ">
          <h1 className='h4 mt-5 d-flex justify-content-center text-dark'>
          
          <img width="40" height="30" src="https://img.icons8.com/fluency-systems-filled/48/n.png" alt="n"/> ada </h1>
          <h5 className='title mt-2 '> is the brainchild of a passionate entrepreneur , Nada, who embarked on a journey to redefine women's fashion. With a vision to empower women through clothing, Nada set out to create a brand that celebrates individuality, confidence, and elegance.  </h5>
          <p className='title text-main pt-5'></p>
        </div>
      </div>
    </div>
<div className="container me-5 ">
  <div className="row">
    <div className="col-md-7 mt-5">
      <h1 >About 
        <img width="50" height="50" src="https://img.icons8.com/ios-filled/50/marker-n.png" alt="marker-n"/> </h1>
      <h3 className={`${our.h2} mt-5`} >The letter N is an abbreviation for the new word in Spanish, which is neu, and we gained this name for the brand, because of our future vision, which is to provide everything new and modern to our customers </h3>
    </div>
    <div className="col-md-5 ">
    <img width={400} height={400} src={Image1} alt="" />
