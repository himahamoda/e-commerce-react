...
// import style from './SecHome.module.css'
// import pic1 from "../../Assets/Device=Desktop, Style=Text Block.png"
...
// import pic2 from '../../Assets/Image Block.png'
...
//       <div>
//         <img src={pic1} height={600} alt="" />
//       </div>
//     </div>
//     {/* section2 */}
//     <div className="container ">
//       <div className="row  pt-5 my-5">
//         <h1 className=' text-center mb-5'>What makes our brand different</h1>
//         <div className="col-md-3 bg-light mb-4 ">
...
//           </svg>
//           <h1 className='title'>Next day as standard</h1>
//           <h2 className='title'>Order before 3pm and get your order the next day as standard</h2>
//         </div>
...
//           <h1 className=' fw-bolder text-white my-2 '>It started with a small idea</h1>
//           <h2 className='title text-white mt-5 pb-5'>A global brand with local beginnings, our story begain in a small studio in South London in early 2014</h2>
//           <button className={`${style.button}`}>View Collection</button>
//         </div>
...
//         <div class="row">
//           <div class="col-md-12  ">
//             <h2 className='text-center pt-5'>Join the club and get the benefits</h2>
//             <p className='text-center'>Sign up for our newsletter and receive exclusive offers on new ranges,<br />
...
//       </div>
//      <div className="row  ">
//      <div className={`${style.offer} col-md-4 `}>
//         <h2 className='title fw-semibold' ><svg className='' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
...
// </svg>Exclusive offers</h2>
//       </div>
//      <div className={`${style.offer} col-md-4 `}>
//         <h2 className='title fw-semibold'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
//   <path d="M8 1C6.61553 1 5.26216 1.41054 4.11101 2.17971C2.95987 2.94888 2.06266 4.04213 1.53285 5.32122C1.00303 6.6003 0.86441 8.00776 1.13451 9.36563C1.4046 10.7235 2.07129 11.9708 3.05026 12.9497C4.02922 13.9287 5.2765 14.5954 6.63437 14.8655C7.99224 15.1356 9.3997 14.997 10.6788 14.4672C11.9579 13.9373 13.0511 13.0401 13.8203 11.889C14.5895 10.7378 15 9.38447 15 8C15 6.14348 14.2625 4.36301 12.9497 3.05025C11.637 1.7375 9.85652 1 8 1ZM7 10.7954L4.5 8.2954L5.2953 7.5L7 9.2046L10.705 5.5L11.5029 6.29295L7 10.7954Z" fill="white"/>
// </svg>Free events</h2>
//       </div>
//      <div className={`${style.offer} col-md-4`}>
//         <h2 className='title fw-semibold'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
//   <path d="M8 1C6.61553 1 5.26216 1.41054 4.11101 2.17971C2.95987 2.94888 2.06266 4.04213 1.53285 5.32122C1.00303 6.6003 0.86441 8.00776 1.13451 9.36563C1.4046 10.7235 2.07129 11.9708 3.05026 12.9497C4.02922 13.9287 5.2765 14.5954 6.63437 14.8655C7.99224 15.1356 9.3997 14.997 10.6788 14.4672C11.9579 13.9373 13.0511 13.0401 13.8203 11.889C14.5895 10.7378 15 9.38447 15 8C15 6.14348 14.2625 4.36301 12.9497 3.05025C11.637 1.7375 9.85652 1 8 1ZM7 10.7954L4.5 8.2954L5.2953 7.5L7 9.2046L10.705 5.5L11.5029 6.29295L7 10.7954Z" fill="white"/>
// </svg>Large discounts</h2>
//       </div>
//      </div>
//      <div className="row justify-content-center  pt-5">
//      <div className="col-md-2 me-5 ">
//       <label htmlFor="sign up" ></label>
//       <input id='email' className="form-control-lg  border mt-2 " type="email" placeholder="email" />
//      </div>
